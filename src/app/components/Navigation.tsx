...
const Navigation = () => {
  ...
  return (
    <nav className="w-full p-5 flex flex-row items-center justify-between bg-white bg-opacity-80 shadow-md fixed top-0 left-0 z-50">
      ...
      <div className="relative flex items-center gap-5">
        ...
        {query && filteredRecipes.length > 0 && (
          <div className="absolute bg-white shadow-md w-80 mt-2 rounded-md z-10">
